        ...
        button_sbm.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                        ...
                        Toast.makeText(RecognitionActivity.this,"present",
                               Toast.LENGTH_SHORT).show();
                        //Intent intent=new Intent(RecognitionActivity.this,Main2Activity.class);
                        //startActivity(intent);fh = new FileHelper();
